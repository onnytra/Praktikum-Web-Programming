...
if( !isset($_GET['id']) ){
    ...
    document.location.href = 'view_akun.php';
    </script>";
}
...
<body>
<div class="m-md-4">
        <form action="../action/proses-update-akun.php" method="post" enctype="multipart/form-data">
            <h3>UPDATE</h3>
            ...
            <a href="view_akun.php" class="btn btn-secondary me-2"> Cancel </a>
        </form>
    </div>
</body>
</html>