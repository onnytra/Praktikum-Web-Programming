...
if (!isset($_GET['id'])) {
    ...
    document.location.href = 'read_pettutor.php';
    </script>";
}

$tutor = $_GET['id'];
$sql = "SELECT * FROM pet_tutor WHERE id_tutor=$tutor";
...
<body>
    <div class="m-md-4">
        <form action="../action/proses-update-pettutor.php" method="post" enctype="multipart/form-data">
            <h3>UPDATE</h3>
            <input type="hidden" name="id" value="<?php echo $data['id_tutor'] ?>">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="link"><?php echo $data['link'] ?>"</textarea>
            </div>
            <div class="mb-3">
