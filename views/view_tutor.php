        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 g-2">
                    <?php
                    include "../koneksi.php";
                    $sql = "SELECT judul, tanggal, link, var_foto FROM pet_tutor";
                    $query = mysqli_query($koneksi, $sql);
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="../assets/<?php echo $data["var_foto"] ?>" alt="PetTutor" width="550px" height="350px">
                                <div class="card-body">
                                    <h6><?php echo $data["tanggal"] ?></h6>
                                    <h6 class="card-title"><?php echo $data["judul"]?></h6>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="<?php echo $data["link"] ?>" class="btn btn-sm btn-outline-danger" target="blank">YouTube</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
